...
import { CpyInviteEmployeeService } from '../../../../modules/company/services/rest/cpy-invite-employee.service';
import { CpyShowEmployeesService } from '../../../../modules/company/services/rest/cpy-show-employees.service';
...
@Component({
  selector: 'app-emp-rubrica',
  templateUrl: './emp-rubrica.component.html',
  styleUrls: ['./emp-rubrica.component.css']
})
export class EmpRubricaComponent implements OnInit {
