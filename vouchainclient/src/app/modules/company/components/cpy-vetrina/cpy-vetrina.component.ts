...
/* Services   */
import { EmpShowMerchantsService } from 'src/app/modules/employee/services/rest/emp-show-merchants.service';
...
@Component({
  selector: 'app-cpy-vetrina',
  templateUrl: './cpy-vetrina.component.html',
  styleUrls: ['./cpy-vetrina.component.css']
})
export class CpyVetrinaComponent implements OnInit {
