...
@Component({
  selector: 'app-cpy-employees',
  templateUrl: './cpy-employees.component.html',
  styleUrls: ['./cpy-employees.component.css'],
})
export class CpyEmployeesComponent implements OnDestroy, OnInit {
  /* vvv ATTRIBUTES vvv */
  //#region
